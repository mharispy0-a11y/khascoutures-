...
const SECTION_META: Record<string, { category: string; title: string; description: string; gradient: string }> = {
  bridal: {
...
const STATIC_PRODUCTS: Product[] = [
  { id: "s1", name: "Crimson Zari Lehenga",   category: "bridal", fabric: "Raw Silk",      embroidery: "Zardozi & Dabka",           price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Crimson Zari Lehenga",   sort_order: 10, is_active: true, created_at: "" },
  { id: "s2", name: "Ivory Walima Ensemble",  category: "bridal", fabric: "Chiffon",       embroidery: "Thread & Sequins",          price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Ivory Walima Ensemble",  sort_order: 20, is_active: true, created_at: "" },
  { id: "s3", name: "Garnet Anarkali",        category: "bridal", fabric: "Net over Silk", embroidery: "Mirror & Gota",             price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Garnet Anarkali",        sort_order: 30, is_active: true, created_at: "" },
  { id: "s4", name: "Blush Sharara Set",      category: "bridal", fabric: "Organza",       embroidery: "Cut-Dana & Resham",         price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Blush Sharara Set",      sort_order: 40, is_active: true, created_at: "" },
  { id: "s5", name: "Forest Satin Co-ord",    category: "party",  fabric: "Premium Satin", embroidery: "Aari Embroidery",           price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Forest Satin Co-ord",    sort_order: 50, is_active: true, created_at: "" },
  { id: "s6", name: "Midnight Farshi Pyjama", category: "party",  fabric: "Velvet",        embroidery: "Gota & Tilla",              price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Midnight Farshi Pyjama", sort_order: 60, is_active: true, created_at: "" },
  { id: "s7", name: "Bronze Palazzo Set",     category: "party",  fabric: "Tissue",        embroidery: "Sequin & Beads",            price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Bronze Palazzo Set",     sort_order: 70, is_active: true, created_at: "" },
  { id: "s8", name: "Plum Jacket Kurta",      category: "party",  fabric: "Jamawar",       embroidery: "Block Print",               price_on_request: true,  price_pkr: null, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Plum Jacket Kurta",      sort_order: 80, is_active: true, created_at: "" },
  { id: "s9", name: "Sage Lawn 3-Piece",      category: "pret",   fabric: "Premium Lawn",  embroidery: "Digital Print + Embroidery",price_on_request: false, price_pkr: 12000, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Sage Lawn 3-Piece",      sort_order: 90, is_active: true, created_at: "" },
  { id: "s10",name: "Terracotta Kurta Set",   category: "pret",   fabric: "Cambric",       embroidery: "Hand Block",                price_on_request: false, price_pkr: 9500,  image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Terracotta Kurta Set",   sort_order: 100,is_active: true, created_at: "" },
  { id: "s11",name: "Navy Chiffon Dupatta",   category: "pret",   fabric: "Chiffon",       embroidery: "Printed",                   price_on_request: false, price_pkr: 14000, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Navy Chiffon Dupatta",   sort_order: 110,is_active: true, created_at: "" },
  { id: "s12",name: "Dusty Rose Co-ord",      category: "pret",   fabric: "Cotton",        embroidery: "Schiffli Lace",             price_on_request: false, price_pkr: 11000, image_url: null, image_alt: null, whatsapp_enquiry_text: "I'm interested in the Dusty Rose Co-ord",      sort_order: 120,is_active: true, created_at: "" },
];
              ...
              <div className="max-w-7xl mx-auto">
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-start`}>
                  ...
                  <div className={idx % 2 !== 0 ? "order-1 lg:order-2" : ""}>
                    <div className={`aspect-[4/3] bg-gradient-to-br ${col.gradient} relative border border-gold/20`}>
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-gold/20 font-display text-9xl" style={{ fontFamily: "var(--font-cormorant)" }}>
                          {col.title[4]}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                      {col.pieces.map((piece) => (
                        <a
                          ...
                          className="border border-gold/15 bg-warm-white p-4 card-hover block group"
                        >
